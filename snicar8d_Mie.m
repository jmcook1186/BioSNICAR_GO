...
function data_out = snicar8d_GO(BND_TYP_IN, DIRECT_IN, APRX_TYP_IN, ...
                             ...
                             mss_cnc_ash1_in,mss_cnc_snw_alg_in, mss_cnc_ancyl_in, mss_cnc_hematite_in, mss_cnc_mixed_sand_in, fl_sot1_in, fl_sot2_in, ...
                             fl_dst1_in, fl_dst2_in, fl_dst3_in, fl_dst4_in, ...
                             fl_ash1_in,fl_snw_alg_in, fl_ancyl_in, fl_hematite_in, fl_mixed_sand_in);
...
fl_in8 = strcat(fl_snw_alg); % JC EDIT
fl_in9 = strcat(fl_ancyl); % JC EDIT
fl_in10 = strcat(wrkdir,fl_hematite); % JC EDIT
fl_in11 = strcat(wrkdir,fl_mixed_sand); % JEC EDIT
...
mss_cnc_aer(1:nbr_lyr,8) = mss_cnc_snw_alg; % JC EDIT
mss_cnc_aer(1:nbr_lyr,9) = mss_cnc_ancyl; %JC EDIT
mss_cnc_aer(1:nbr_lyr,10) = mss_cnc_hematite; % JC EDIT
mss_cnc_aer(1:nbr_lyr,11) = mss_cnc_mixed_sand; % JC EDIT
